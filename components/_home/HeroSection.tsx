...
export default function HeroSection() {
  return (
    <div className="bg-[#fff]">
      <div className="max-w-7xl mx-auto px-6 pt-24 pb-[120px]">
        <div className="text-center mx-auto">
          <h1 className="text-[80px] font-black leading-[1.29]">
          ...
          <p className="text-[18px] font-normal pt-6.5 pb-11 leading-[1.83] text-center opacity-90" style={{ fontFamily: 'SegoeUI, sans-serif' }}>
            The most powerful and easy-to-use data collection API. 50+ ready-made crawlers, <br />
