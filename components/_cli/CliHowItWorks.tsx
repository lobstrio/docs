    ...
    <section className="border-b border-[#dee0ea]">
      <div className="max-w-4xl mx-auto px-6 py-10 md:py-[80px]">
        ...
        <div className="flex flex-col md:flex-row gap-10">
          <StepsColumn steps={CLI_STEPS} variant="cards" className="w-full md:w-[45%] shrink-0" />

          <div className="w-full md:flex-1 rounded-lg overflow-hidden flex flex-col mt-7.5 md:mt-0 md:h-[410px]">
            <TerminalHeader />
            <div className="bg-[#0a1b2b] px-6 py-5 text-[13px] font-normal font-mono leading-[2.43] flex-1 flex flex-col gap-0 items-start justify-center">
