...
import { CLI_INSTALL_CODE } from './data';
  ...
  return (
    <section id="installation" className="border-b bg-[#f8fafc] border-[#dee0ea]">
      <div className="max-w-4xl mx-auto px-6 md:px-0 py-10 md:py-[80px]">
        <SectionHeader label="Setup" title="Connect in one step" subtitle="Requires Python 3.10+. No API key needed to browse crawlers. Add your token to run scraping jobs." />
        ...
        <div className="bg-[#0a2540] rounded-xl overflow-hidden">
          <div className="flex justify-between items-center gap-2 px-4 py-3">
            ...
            <CopyButton text={CLI_INSTALL_CODE} variant="dark" className="border !border-[#213447] !bg-[#213447]" />
          </div>
          <CodeBlock code={CLI_INSTALL_CODE} language="bash" theme="dark" showLabel={false} codeBg="#0a1b2b" className='[&>pre]:!p-5 [&>pre]:!m-0' />
        </div>
