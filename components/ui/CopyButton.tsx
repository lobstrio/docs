  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`${variant === 'dark' ? 'h-[45px] w-[45px] p-[2px]' : 'h-[28px] w-[28px] p-1.5'} flex justify-center text-sm font-semibold leading-[1.36] cursor-pointer border border-[#dee0ea] rounded-[7px] items-center gap-2 ${className}`}
