...
<Note>
  There are 20 account types at the time of writing (Facebook, LinkedIn, Sales Navigator, Twitter/X, Instagram, Leboncoin, and more platform-specific ones). The example below shows 4 for brevity — `total_results` reflects the real full count.
</Note>
...
```json 200
{
  ...
  "data": [
    ...
    {
      "id": "77472acc63e41abde1fa2afd24bece4c",
      "object": "account_type",
      "name": "linkedin-sync",
      "icon": "<base64 image data>",
      "domain": "Linkedin",
      "params": {
        "profiles": {
          "max": 1000,
          "default": 800,
          "display": "Profiles per day",
          "description": "Maximum number of profiles the account can scrape per day. Once this limit is reached, the run linked to this account pauses for 24 hours."
        }
      },
