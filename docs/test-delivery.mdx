...
api: "POST https://api.lobstr.io/v1/delivery/test-webhook"
---

Test endpoints allow you to verify your delivery configurations work correctly before activating automatic delivery. Each delivery method has its own distinct endpoint — there is no shared endpoint with a channel query parameter.
