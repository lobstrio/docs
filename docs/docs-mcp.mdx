...
description: "A public, no-auth MCP server that gives AI assistants semantic search and read access to the lobstr.io API documentation. To run scrapers in your account, see the MCP Server page instead."
---
