...
description: "Configure the LaCentrale Listing Status Checker settings"
api: "POST https://api.lobstr.io/v1/squids/{squid_hash}"
---

Configure your **LaCentrale Listing Status Checker** squid settings. This scraper has no scraper-specific parameters beyond a global run limit.
...
curl -X POST "https://api.lobstr.io/v1/squids/YOUR_SQUID_HASH" \
  ...
  -d '{
    "name": "LaCentrale Listing Status Checker (1)",
    "concurrency": 5,
