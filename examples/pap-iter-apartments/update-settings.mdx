...
| **fetch_since** | string | — | Only keep listings published after this point (based on `publication_date`). Use a relative duration (`24h`, `7d`, `2w`) or an absolute date (`YYYY-MM-DD HH:MM:SS`) |
