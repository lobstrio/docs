...
| --- | --- | --- | --- |
| **max_pages** | integer | 60 | Maximum number of search result pages to scrape (max: 100) |
| **get_property_details** | boolean | false | Visit each listing page to collect full property characteristics (year built, orientation, energy certificate, community costs, etc.). Increases credit usage. |
...
<Tip>
  Idealista typically shows 30 listings per page. Setting max_pages to 60 can yield up to 1,800 listings per search URL.
</Tip>
