...
<ResponseField name="certifications" type="json">
  Certifications listed on the member's profile. Example: `[{"name": "AWS Solutions Architect", "authority": "Amazon Web Services"}]`
</ResponseField>

<ResponseField name="languages" type="json">
  Languages listed on the member's profile. Example: `[{"name": "English", "proficiency": "NATIVE_OR_BILINGUAL"}]`
</ResponseField>

<ResponseField name="honors" type="json">
  Honors and awards listed on the member's profile.
</ResponseField>

<ResponseField name="projects" type="json">
  Projects listed on the member's profile.
</ResponseField>

<ResponseField name="publications" type="json">
  Publications listed on the member's profile.
</ResponseField>

<ResponseField name="patents" type="json">
  Patents listed on the member's profile.
</ResponseField>

<ResponseField name="organizations" type="json">
  Organizations listed on the member's profile.
</ResponseField>

<ResponseField name="courses" type="json">
  Courses listed on the member's profile.
</ResponseField>

<ResponseField name="is_verified" type="boolean">
  Whether the member has LinkedIn's verified badge. Example: `false`
</ResponseField>

<ResponseField name="hiring" type="boolean">
  Whether the member is actively hiring (shows a hiring frame on their profile picture). Example: `false`
</ResponseField>
...
The following fields require `enrich_company: true` in settings.

<ResponseField name="company_id" type="string">
  LinkedIn numeric identifier of the lead's current company.
</ResponseField>

<ResponseField name="company_universal_name" type="string">
  LinkedIn vanity slug of the lead's current company. Example: `microsoft`
</ResponseField>

<ResponseField name="company_name" type="string">
  Name of the lead's current company as listed on LinkedIn. Example: `Microsoft`
</ResponseField>

<ResponseField name="company_website" type="string">
  Company website URL as listed on LinkedIn. Example: `https://www.microsoft.com`
</ResponseField>

<ResponseField name="company_domain" type="string">
  Apex domain of the company's website. Example: `microsoft.com`
</ResponseField>

<ResponseField name="company_industry" type="string">
  LinkedIn industry of the company. Example: `Software Development`
</ResponseField>
...
<ResponseField name="company_headcount" type="integer">
  Exact number of LinkedIn members listing this company. Example: `228000`
</ResponseField>

<ResponseField name="company_followers" type="integer">
  Number of LinkedIn followers of the company. Example: `18000000`
</ResponseField>

<ResponseField name="company_hq" type="string">
  Headquarters location as displayed on the company page. Example: `Redmond, Washington, United States`
</ResponseField>

<ResponseField name="company_hq_city" type="string">
  City of the company headquarters. Example: `Redmond`
</ResponseField>

<ResponseField name="company_hq_country" type="string">
  Country code of the company headquarters. Example: `US`
</ResponseField>

<ResponseField name="company_description" type="string">
  Full 'About us' description of the company.
</ResponseField>

<ResponseField name="company_tagline" type="string">
  Short tagline displayed under the company name. Example: `Empowering every person and organization on the planet to achieve more.`
</ResponseField>

<ResponseField name="company_specialties" type="json">
  List of specialties declared by the company. Example: `["Business Software", "Developer Tools", "Cloud Computing"]`
</ResponseField>

<ResponseField name="company_logo" type="string">
  URL of the company logo image. Example: `https://media.licdn.com/dms/image/v2/microsoft-logo.jpg`
</ResponseField>

<ResponseField name="company_verified" type="boolean">
  Whether LinkedIn displays the verified badge on the company page. Example: `true`
</ResponseField>
  ...
  "data": [
    {
      "id": 55625,
      "object": "result",
      "squid": "be678e3927864c2d61154e02da6170fb",
      "run": "a84a32dd363a98569fb73eb6084c8c33",
      ...
      "vmid": "251749025",
      "sales_nav_url": "https://www.linkedin.com/sales/people/251749025",
      "connection_degree": "2",
      "connections_url": "https://www.linkedin.com/search/results/people/?facetConnectionOf=%5B%22251749025%22%5D",
      "mutual_connections_url": "https://www.linkedin.com/search/results/people/?facetNetwork=%5B%22F%22%5D&facetConnectionOf=%5B%22251749025%22%5D",
      "mutual_connections_text": "3 mutual connections",
      "picture_url": "https://media.licdn.com/dms/image/v2/example.jpg",
      "background_picture_url": "https://media.licdn.com/dms/image/v2/example-bg.jpg",
      "is_creator": true,
      "open_to_work": false,
      "num_connections": 500,
      "num_followers": 35000000,
      "skills": [
        "Software Development",
        "Philanthropy"
      ],
      "job_1": {},
      "job_1_title": "Co-chair",
      "job_1_company_name": "Bill & Melinda Gates Foundation",
      "job_1_company_url": "https://www.linkedin.com/company/bill-melinda-gates-foundation/",
      "job_1_company_logo": "https://media.licdn.com/dms/image/v2/example-logo.jpg",
      "job_1_location": "Seattle, WA",
      "job_1_description": "Leading philanthropic initiatives...",
      "job_1_start_year": 2000,
      "job_1_start_month": 1,
      "job_1_end_year": null,
      "job_1_end_month": null,
      "job_2": {},
      "job_2_title": null,
      "job_2_company_name": null,
      "job_2_company_url": null,
      "job_2_company_logo": null,
      "job_2_location": null,
      "job_2_description": null,
      "job_2_start_year": null,
      "job_2_start_month": null,
      "job_2_end_year": null,
      "job_2_end_month": null,
      "job_3": {},
      "job_3_title": null,
      "job_3_company_name": null,
      "job_3_company_url": null,
      "job_3_company_logo": null,
      "job_3_location": null,
      "job_3_description": null,
      "job_3_start_year": null,
      "job_3_start_month": null,
      "job_3_end_year": null,
      "job_3_end_month": null,
      "education_1": {},
      "education_2": {},
      "education_3": {},
      "interests_companies": [],
      ...
      "educations": [],
      "functions": null,
      "scraping_time": "2026-04-01T10:00:00Z",
      "native_id": 55625
    }
  ],
  "next": null,
