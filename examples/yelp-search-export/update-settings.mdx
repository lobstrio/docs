...
| **min_star_rating** | float | null | Only show businesses with at least this star rating (e.g. `3.5`, `4.0`) |
| **min_reviews** | integer | null | Only show businesses with at least this many reviews |
