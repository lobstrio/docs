...
| **get_details** | boolean | false | Collect extra details for each company: website, domain, LinkedIn page URL, exact employee count, founded year, specialties, company type, revenue range, and headquarters location |

<Note>
  Setting `get_details: true` enables additional company detail fields in results.
</Note>
