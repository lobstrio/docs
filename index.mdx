...
description: "The most powerful and easy-to-use data collection API. 55+ ready-made crawlers, simple REST endpoints, structured JSON output."
---
...
<CardGroup cols={3}>
  ...
  <Card title="MCP Server" icon="robot" href="/docs/mcp">
    Run scrapers from Claude, ChatGPT, or Cursor.
  </Card>
</CardGroup>
